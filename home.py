    ...
    fourth_frame = Row([
        Container(
            content=Column([
                ...
                ElevatedButton(width=200,height=60,color='white',bgcolor='#7A288A',on_hover=animate_buttons,content=Container(content=Stack([Image(src_base64=icons[23],width=60,height=60,top=0,left=0),Text('school year                           subject',size=20,text_align=TextAlign.CENTER,offset=Offset(0.1,0))])))
